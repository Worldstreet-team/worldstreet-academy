...
- Owner, 2026-09-18 (revised 2026-09-21): the landing hero may auto-advance a background slideshow (pause control, pauses off-screen/hidden tab, no autoplay under reduced motion) — the one exception to the no-loops rule. It cycles four student cutouts (`public/brand/hero/`, each holding something with the gold W mark); a chosen school brings on that school's cover instead, and "Clear" returns to the students.
